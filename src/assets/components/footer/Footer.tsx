        ...
        <>
            ...
            <footer className="w-full bg-[#f5a518] pb-[80px] md:pb-0">
                ...
                <div  className='max-w-[1276px] mx-auto px-5 py-14 grid grid-cols-4 justify-items-center gap-2 md:gap-5 '>
                    ...
                    <a href='https://patense.com.br/' className='w-full md:min-h-[160px] p-5 flex justify-center items-center bg-white shadow-2xl rounded-3xl cursor-pointer '>
                        <img src={logoPatense} className=' ' alt="" />
                    </a>

                    <a href='https://petsmellon.com.br/' className='w-full md:min-h-[160px] p-5 flex justify-center items-center bg-white shadow-2xl rounded-3xl cursor-pointer '>
                        <img src={logoPetsmellon} className=' ' alt="" />
                    </a>

                    <a href='https://lojazoomies.com/' className='w-full md:min-h-[160px] p-5 flex justify-center items-center bg-white shadow-2xl rounded-3xl cursor-pointer '>
