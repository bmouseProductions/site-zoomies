...
export default function Header(){
    ...
    return (
        <header className="fixed top-0 z-50 w-full min-h-[104px] px-5 py-5 flex items-center justify-between text-white backdrop-blur-md menuNavigation">
          <Link to="/" id='logoImg' className=''>
            <img src={logo} className="max-w-[200px] h-[50px] md:max-w-xs " alt="" />
          </Link>
          
          <nav className="w-full  hidden md:flex justify-around">
